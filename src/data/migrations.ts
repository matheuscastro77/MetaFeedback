...
export class CreateTables extends BaseDatabase{
  ...
  CREATE TABLE IF NOT EXISTS FORM (
    ...
    date timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    SYSTEM_USER_id VARCHAR(255) NULL,
  ...
  CREATE TABLE IF NOT EXISTS ANSWER_FORM (
    ...
    LEAGUER_ANSWER_id VARCHAR(45) NOT NULL,
    FOREIGN KEY (SYSTEM_USER_id) REFERENCES SYSTEM_USER(id),
    FOREIGN KEY (LEAGUER_ANSWER_id) REFERENCES PERFIL_LEAGUER(id)
  );
